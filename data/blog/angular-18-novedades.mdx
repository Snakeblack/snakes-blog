...
Angular 18 continúa invirtiendo en mejorar la experiencia y el rendimiento del renderizado en el servidor (SSR) y el proceso de _hydration_. La hydration es fundamental: es el mecanismo que toma el HTML renderizado en el servidor y lo "conecta" con el JavaScript en el cliente, haciéndolo interactivo sin tener que volver a renderizar todo desde cero.
