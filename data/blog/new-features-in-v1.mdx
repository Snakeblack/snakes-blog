...
For example, the following frontmatter will display the authors given by `data/authors/default.md` and `data/authors/elonmusk.md`
...
.highlight-line {
  @apply -mx-4 border-l-4 border-primary-500 bg-gray-700/50;
}
...
```jsx
<BlogNewsletterForm title="¿Te gusta lo que lees?" />
```
